...
export const solutions: Solution[] = [
  ...
  },
  {
    ...
    shortDescription:
      "NOW Systems dynamic check weighers for inline weight verification, rejection, and production logging.",
    overview:
      "NOW Systems check weighers verify every pack on the line — from automatic and high-speed models to heavy-duty, multi-lane, and metal detector integrated systems. Exalted supplies the full weighing range for food, pharma, and FMCG production with giveaway control and compliance reporting.",
    features: [
      "Automatic in-motion weighing with NWC-3000 ABACUS",
      "High-speed and heavy-duty check weigher models",
      "Multi-lane high accuracy and high speed options",
      "Integrated metal detector and check weigher systems",
      "Over/under rejection with production logging",
    ],
    applications: [
      "Pack weight verification on food lines",
      "Pharma carton weight checks",
      "High-speed multi-lane production",
      "Heavy product and bulk pack weighing",
      "Combined metal detection and weight check",
    ],
    industries: ["Food & Beverage", "Pharma & Life Sciences", "Packaging & FMCG"],
